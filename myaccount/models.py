...
class ApplicationAPIKey(AbstractAPIKey):
    ...
    # Ownership / Audit
    associated_user = models.ForeignKey('myaccount.User', on_delete=models.CASCADE, help_text="Represents the user context for this API key. Requests authenticated with this key will assume this user's identity.")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
